...
class GoldAnalyzerApp:
    ...
    def _build_ui(self):
        ...
        tk.Label(tf, text="\u26a1 HJ ANALYZER  v3.060 \u26a1", font=("Consolas", 14, "bold"),
    ...
    def _draw_chart(self, fig, a, title_prefix, chart_tv):
        ...
        if an is not None:
            ...
            an = ax.annotate('倒计时: ' + cd, xy=(1, 0.95), xycoords='axes fraction', fontsize=10, ha='right', va='top', color=self.C['yellow'], fontweight='bold')
            setattr(self, ak, an)
